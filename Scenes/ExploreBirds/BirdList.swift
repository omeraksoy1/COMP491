...
var birdDescs = ["The Eurasian siskin (Spinus spinus) is a small passerine bird in the finch family Fringillidae. It is also called the European                        siskin, common siskin or just siskin. Other (archaic) names include black-headed goldfinch,[2] barley bird and aberdevine.[3] It is                 very common throughout Europe and Eurosiberia. It is found in forested areas, both coniferous and mixed woodland where it feeds on                  seeds of all kinds, especially of alder and conifers.",
                 ...
                 "It  was first described as Picus syriacus by Wilhelm Hemprich and Christian Gottfried Ehrenberg in 1833, from a specimen collected on Mount Lebanon.[3]'",
                 "'The Eurasian wren (Troglodytes troglodytes) is a very small insectivorous bird, and the only member of the wren family Troglodytidae found in Eurasia and Africa (Maghreb). In Anglophone Europe, it is commonly known simply as the wren. It has a very short tail which is often held erect, a short neck and a ",
                 ...
                 "'",
                 "The grey-headed swamphen (Porphyrio poliocephalus) is a species of swamphen",
                 " occurring from the Middle East and the Indian subcontinent to southern ",
                 "China and northern Thailand. It used to be considered a subspecies of ",
                 "the purple swamphen, but was elevated to full species status in 2015; today the purple swamphen is considered a superspecies and each of its six subspecies groups are designated full species.[1]'",
                 ...
                 "the specific audouinii and the English name are after the French naturalist Jean Victoire Audouin.[2]'",
                 ...
                 "It is a slender, 15.5–17 cm long bird, with the long, constantly wagging tail characteristic of the genus Motacilla. The adult male in breeding plumage is basically grey or black above, with white on the remiges,",
                 " and bright yellow below and on the entire head except for the black ",
                 "nape. In winter plumage, its yellow underparts may be diluted by white, ",
                 "and the head is brownish with a yellowish supercilium. Females look generally like washed-out versions of males in winter plumage.'",
                 ...
                 "'The Bohemian waxwing (Bombycilla garrulus) is a starling-sized passerine bird that breeds in the northern forests of the Palearctic and North America. It has mainly buff-grey plumage,",
                 " black face markings and a pointed crest. Its wings are patterned with ",
                 "white and bright yellow, and some feather tips have the red waxy ",
                 "appearance that give this species its English name. The three subspecies",
                 " show only minor differences in appearance. Females are similar to ",
                 "males, although young birds are less well-marked and have few or no waxy",
                 " wingtips. Although the Bohemian waxwing's range overlaps those of the cedar and Japanese waxwings, it is easily distinguished from them by size and plumage differences.'",
